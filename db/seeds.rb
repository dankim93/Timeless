...
User.create(username: 'Kavan Cardoza', password: 'password', profile_url: 'http://res.cloudinary.com/dyjarpgbt/image/upload/v1484440262/pexels-photo-63937_utf6qa.jpg')
...
Photo.create(image_url: 'http://res.cloudinary.com/dyjarpgbt/image/upload/v1484332438/pexels-photo-200303_jkgqpy.jpg', title: 'Dual screen', description: 'Working with multi-screens', user_id: 5, thumb_url: 'http://www.visitberkeley.com/images/header-rotation/OrangeSky_full_web.jpg')
